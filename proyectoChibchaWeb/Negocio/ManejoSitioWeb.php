...
require_once dirname(__FILE__) . '/proyectoChibchaWeb/persistencia/Util/Conexion.php';
require_once dirname(__FILE__) . '/proyectoChibchaWeb/persistencia/SitioWebDAO.php';
