            ...
            <div class="col-lg-12 entries">
                ...
                <article class="entry">
                    ...
                    <div class="entry-content">
                        <form action="ModuloUsuario/creaSitioWeb.php?cod_cliente=<?php echo $cliente->getCod_cliente() ?>" method="post">
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="nombrePaginaWeb" class="form-control" id="nombrePaginaWeb" placeholder="Ingrese el nombre de la página web" required>
                                        <p><br></p>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="descripcion" rows="5" placeholder="Ingrese la descripción de su página web" required></textarea>
                                        <p><br></p>
                                    </div>
                                    <div class="read-more">
                                        <div class="read-more">
