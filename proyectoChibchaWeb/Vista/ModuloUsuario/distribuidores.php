...
<div id="topbar" class="fixed-top d-flex align-items-center topbar-inner-pages">
  ...
  <main id="main">
    ...
    <div class="section-title">
          <h2>Distribuidores </h2>
          <p>Seleccione su Distribuidor.</p>
        </div>
   ...
   foreach ($lista as $t) {
       ...
       <div class="entry-img">
         <img src="../Anyar/assets/img/clients/Amazonlogo.pnsg" alt="" class="img-fluid">
       </div>
       <h2 class="entry-title">
         <a href="registroDominio.php?distri='.$t->getCod_distribuidor().'">'. $t->getNom_distribuidor() .'</a>
       </h2>
       <div class="entry-meta">
         <ul>
           <li class="d-flex align-items-center"><i class="bi bi-bookmark"></i> <a href="#">'. $t->getNom_categoria_distribuidor() .'</a></li>
