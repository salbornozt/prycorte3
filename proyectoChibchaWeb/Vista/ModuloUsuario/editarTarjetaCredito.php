            ...
            <div class="col-lg-12 entries">
                ...
                <article class="entry">
                    ...
                    <div class="entry-content">
                        <form action="ModuloUsuario/editaTarjetaCredito.php?cod_cliente=<?php echo $cliente->getCod_cliente() ?>" method="post">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" name="numeroTarjeta" class="form-control" id="numeroTarjeta" placeholder="" value="<?php echo $cliente_tarjeta->getNumero_tarjeta() ?>" required>
                                        <p><br></p>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" name="cod_seguridad" class="form-control" id="cod_seguridad" placeholder="" value="<?php echo $cliente_tarjeta->getCodigo_seguridad() ?>" required>
                                        <p><br></p>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" name="direccion" class="form-control" id="direccion" placeholder="" value="<?php echo $cliente_tarjeta->getDireccion() ?>" required>
                                        <p><br></p>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select name="marca" id="marca" class="form-control">
                                            ...
                                            <option><?php echo $tipo_tarjeta->getNombre_casa(); ?></option>
                                            <?php
                                    ...
                                    <div class="col-lg-3">
                                        <input type="date" name="fechaExpiracion" class="form-control" id="fechaExpiracion" placeholder="" value="<?php echo $cliente_tarjeta->getFecha_expiracion() ?>" required>
                                        <p><br></p>
                                    </div>
                                </div>
                            </div>
